        ...
        <template v-slot:body>
          <div class="chat-data-block">
            <b-row>
              <b-col
                lg="3"
                class="chat-data-left scroller"
              >
                <div class="chat-search pt-3 pl-3">
                  <ToggleButton toggle-show="#user-detail-popup">
                  ...
                  >
                    ...
                    <template v-slot:body>
                      ...
                      <ul class="user-status p-0">
                        <li class="mb-1">
                          <i class="ri-checkbox-blank-circle-fill text-success pr-1" /><span>Online</span>
                        </li>
                        <li class="mb-1">
                          <i class="ri-checkbox-blank-circle-fill text-warning pr-1" /><span>Away</span>
                        </li>
                        <li class="mb-1">
                          <i class="ri-checkbox-blank-circle-fill text-danger pr-1" /><span>Do Not Disturb</span>
                        </li>
                        <li class="mb-1">
                          <i class="ri-checkbox-blank-circle-fill text-light pr-1" /><span>Offline</span>
                        </li>
                      </ul>
                    </template>
                  </ToggleContent>
                    ...
                    <template>
                          ...
                          <div class="chat-header-icons d-flex">
                            ...
                            >
                              ...
                              <b-dropdown-item href="#">
                                <i
                                  class="fa fa-thumb-tack mr-0"
                                  aria-hidden="true"
                                /> Pin to top
                              </b-dropdown-item>
                              <b-dropdown-item href="#">
                                <i
                                  class="fa fa-trash-o mr-0"
                                  aria-hidden="true"
                                /> Delete chat
                              </b-dropdown-item>
                              <b-dropdown-item href="#">
                                <i
                                  class="fa fa-ban mr-0"
                                  aria-hidden="true"
                                /> Block
                              </b-dropdown-item>
                            </b-dropdown>
                      ...
                      <div class="chat-footer p-3 bg-white">
                        ...
                        >
                          ...
                          >
                            <i class="far fa-paper-plane" /><span class="d-none d-lg-block ml-1">Send</span>
                          </button>
                        </form>
                      </div>
                    </template>
