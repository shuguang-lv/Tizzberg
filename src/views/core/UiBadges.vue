        ...
        <template v-slot:body>
          ...
          >
            <div class="card">
              <kbd class="bg-dark">
                <pre
                  id="button-light-background-badges"
                  class="text-white"
                >
                    <code>
        ...
        <template v-slot:body>
          ...
          >
            <div class="card">
              <kbd class="bg-dark">
                <pre
                  id="contextual-variations-border"
                  class="text-white"
                >
                    <code>
...
&lt;b-badge href="#" class="border border-dark text-dark" variant="none"&gt;Dark&lt;/b-badge&gt;
          ...
          <b-badge
            class="border border-success text-success mr-1"
            variant="none"
          >
            Success
          </b-badge>
          ...
          <b-badge
            class="border border-warning text-warning mr-1"
            variant="none"
          >
            Warning
          </b-badge>
          <b-badge
            class="border border-info text-info mr-1"
            variant="none"
          >
            Info
          </b-badge>
          <b-badge
            class="border border-light text-light mr-1"
            variant="none"
          >
            Light
          </b-badge>
          <b-badge
            class="border border-dark text-dark mr-1"
            variant="none"
          >
            Dark
          </b-badge>
