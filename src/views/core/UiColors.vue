...
&lt;p class="mb-0"&gt;&lt;a href="#" class="iq-bg-dark pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"&gt;Dark link&lt;/a&gt;&lt;/p&gt;
            ...
            <p>
              <a
                href="#"
                class="iq-bg-info pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"
              >Info link</a>
            </p>
            <p class="mb-0">
              <a
                href="#"
                class="iq-bg-dark pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"
              >Dark link</a>
            </p>
          </template>
        </iq-card>
