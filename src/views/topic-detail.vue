...
<template>
  <Layout>
    ...
    >
        ...
        <div v-if="topic">
            <v-card-text class="d-flex align-center text-h5"  v-text="topic.attributes.title">
            </v-card-text>
            <v-row>
            ...
            <v-card-text class="d-flex align-center text-h6"  v-text="topic.attributes.content">
            </v-card-text>
        </div>
