      ...
      <b-row>
        ...
        >
            ...
            <template v-slot:body>
              <ul class="m-0 p-0">
                ...
                >
                  <div
                    class="news-icon"
                    :class="{ 'mb-0': index == news.length - 1 }"
                  >
                    <i class="ri-chat-4-fill" />
                  </div>
                  <p
                    class="news-detail mb-0"
          ...
          <iq-card>
            ...
            <template v-slot:body>
              <ul
                v-for="(feed,index) in twitterFeed"
                :key="index"
                class="pages-lists m-0 p-0"
              >
          ...
          <iq-card>
            ...
            <template v-slot:body>
              <ul
                v-for="(feed,index) in recentPages"
                :key="index"
                class="pages-lists m-0 p-0"
              >
                <li class="d-flex mb-4 align-items-center">
            ...
            >
              <iq-card body-class="p-0">
                    ...
                    <div class="d-flex flex-wrap">
                      <div class="media-support-user-img mr-3">
                        <b-img
                          rounded="circle"
                          fluid
                          :src="require('../../assets/images/user/user-01.jpg')"
                          alt=""
                        />
                      </div>
                      ...
                      <div class="iq-card-header-toolbar d-flex align-items-center">
                        ...
                        >
                          <template v-slot:button-content>
                            ...
                            >
                              29 mins <i class="ri-more-2-line ml-3" />
                            </b-link>
                          </template>
                ...
                <div class="user-post">
                  <b-link href="javascript:void(0);">
                    <b-img
                      :src="require('../../assets/images/page-img/p1.jpg')"
                      alt="post-image"
                      fluid
                    />
                  </b-link>
                ...
                <div class="comment-area p-3">
                      ...
                      <div class="iq-media-group">
                        ...
                        >
                          <b-img
                            ...
                            rounded="circle"
                            fluid
                            :src="require('../../assets/images/user/user-05.jpg')"
                            alt=""
                          />
                        </b-link>
                        <b-link
                        ...
                        >
                          <b-img
                            ...
                            rounded="circle"
                            fluid
                            :src="require('../../assets/images/user/user-06.jpg')"
                            alt=""
                          />
                        </b-link>
                        <b-link
                        ...
                        >
                          <b-img
                            ...
                            rounded="circle"
                            fluid
                            :src="require('../../assets/images/user/user-07.jpg')"
                            alt=""
                          />
                        </b-link>
                        <b-link
                        ...
                        >
                          <b-img
                            ...
                            rounded="circle"
                            fluid
                            :src="require('../../assets/images/user/user-08.jpg')"
                            alt=""
                          />
                        </b-link>
                        <b-link
                        ...
                        >
                          <b-img
                            ...
                            rounded="circle"
                            fluid
                            :src="require('../../assets/images/user/user-09.jpg')"
                            alt=""
                          />
                        </b-link>
                      </div>
                  ...
                  <ul class="post-comments p-0 m-0">
                    <li class="mb-2">
                      <div class="d-flex flex-wrap">
                        <div class="user-img">
                          <b-img
                            :src="require('../../assets/images/user/user-02.jpg')"
                            alt="userimg"
                            class="avatar-35"
                            rounded="circle"
                            fluid
                    ...
                    <li>
                      <div class="d-flex flex-wrap">
                        <div class="user-img">
                          <b-img
                            :src="require('../../assets/images/user/user-03.jpg')"
                            alt="userimg"
                            class="avatar-35"
                            rounded="circle"
                            fluid
                  ...
                  >
                    ...
                    <div class="comment-attagement d-flex">
                      <b-link href="javascript:void(0);">
                        <i class="ri-user-smile-line mr-2" />
                      </b-link>
                      <b-link href="javascript:void(0);">
                        <i class="ri-camera-line mr-2" />
                      </b-link>
                    </div>
                  </b-form>
                </div>
                        ...
                        >
                          <template v-slot:button-content>
                            <b-link
                              ...
                              class="text-secondary"
                            >
                              1 hr <i class="ri-more-2-line ml-3" />
                            </b-link>
                          </template>
                          <b-dropdown-item href="#">
                            <i class="ri-user-unfollow-line mr-2" />Unfollow
