            ...
            <div class="row justify-content-between">
              ...
              <div class="col-sm-12 col-md-6">
                <div class="user-list-files d-flex float-right">
                  <a
                    href="#"
                    class="chat-icon-phone btn iq-bg-primary"
                  >
                    Print
                  </a>
                  <a
                    href="#"
                    class="chat-icon-video btn iq-bg-primary"
                  >
                    Excel
                  </a>
                  <a
                    href="#"
                    class="chat-icon-delete btn iq-bg-primary"
                  >
                    Pdf
                  </a>
                </div>
            ...
            <table class="files-lists table table-striped mt-4">
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    <img
                      class="rounded-circle img-fluid avatar-40 mr-2"
                      :src="item.img"
                      alt="profile"
                    > {{ item.imgTitle }}
                  </td>
